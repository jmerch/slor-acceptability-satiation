...
POLAR_0 = read.csv("gpt2_satiation/output/surprisals/gen_WH0_WHtest_surprisals.csv")
...
SUBJ_0 = read.csv("gpt2_satiation/output/surprisals/gen_WH0_WHtest_surprisals.csv")
...
CNPC_0 = read.csv("gpt2_satiation/output/surprisals/gen_WH0_WHtest_surprisals.csv")
