...
WH_0 = read.csv("gpt2_satiation/output/surprisals/gen_WH_0_surprisals.csv")
WH_10 = read.csv("gpt2_satiation/output/surprisals/gen_WH_10_surprisals.csv")
WH_20 = read.csv("gpt2_satiation/output/surprisals/gen_WH_20_surprisals.csv")
WH_30 = read.csv("gpt2_satiation/output/surprisals/gen_WH_30_surprisals.csv")
