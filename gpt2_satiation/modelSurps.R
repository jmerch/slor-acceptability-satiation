...
WH_0 = read.csv("gpt2_satiation/output/surprisals/gen_WH0_WHtest_surprisals.csv")
WH_10 = read.csv("gpt2_satiation/output/surprisals/gen_WH10_WHtest_surprisals.csv")
WH_20 = read.csv("gpt2_satiation/output/surprisals/gen_WH20_WHtest_surprisals.csv")
WH_30 = read.csv("gpt2_satiation/output/surprisals/gen_WH30_WHtest_surprisals.csv")
...
SUBJ_10 = read.csv("gpt2_satiation/output/surprisals/gen_SUBJ10_SUBJtest_surprisals.csv")
SUBJ_20 = read.csv("gpt2_satiation/output/surprisals/gen_SUBJ20_SUBJtest_surprisals.csv")
SUBJ_30 = read.csv("gpt2_satiation/output/surprisals/gen_SUBJ30_SUBJtest_surprisals.csv")
...
CNPC_0 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC0_CNPCtest_surprisals.csv")
CNPC_10 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC10_CNPCtest_surprisals.csv")
CNPC_20 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC20_CNPCtest_surprisals.csv")
CNPC_30 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC30_CNPCtest_surprisals.csv")
