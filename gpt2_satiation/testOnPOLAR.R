...
WH_0 = read.csv("gpt2_satiation/output/surprisals/gen_POLAR_0_surprisals.csv")
...
SUBJ_0 = read.csv("gpt2_satiation/output/surprisals/gen_POLAR_0_surprisals.csv")
...
CNPC_0 = read.csv("gpt2_satiation/output/surprisals/gen_POLAR_0_surprisals.csv")
