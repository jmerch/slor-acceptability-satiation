...
POLAR_0 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC_0_surprisals.csv")
...
WH_0 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC_0_surprisals.csv")
...
SUBJ_0 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC_0_surprisals.csv")
