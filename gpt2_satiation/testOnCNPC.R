...
POLAR_0 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC0_CNPCtest_surprisals.csv")
POLAR_10 = read.csv("gpt2_satiation/output/surprisals/gen_POLAR10_CNPCtest_surprisals.csv")
POLAR_20 = read.csv("gpt2_satiation/output/surprisals/gen_POLAR20_CNPCtest_surprisals.csv")
POLAR_30 = read.csv("gpt2_satiation/output/surprisals/gen_POLAR30_CNPCtest_surprisals.csv")
...
WH_0 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC0_CNPCtest_surprisals.csv")
WH_10 = read.csv("gpt2_satiation/output/surprisals/gen_WH10_CNPCtest_surprisals.csv")
WH_20 = read.csv("gpt2_satiation/output/surprisals/gen_WH20_CNPCtest_surprisals.csv")
WH_30 = read.csv("gpt2_satiation/output/surprisals/gen_WH30_CNPCtest_surprisals.csv")
...
SUBJ_0 = read.csv("gpt2_satiation/output/surprisals/gen_CNPC0_CNPCtest_surprisals.csv")
SUBJ_10 = read.csv("gpt2_satiation/output/surprisals/gen_SUBJ10_CNPCtest_surprisals.csv")
SUBJ_20 = read.csv("gpt2_satiation/output/surprisals/gen_SUBJ20_CNPCtest_surprisals.csv")
SUBJ_30 = read.csv("gpt2_satiation/output/surprisals/gen_SUBJ30_CNPCtest_surprisals.csv")
...
surprisal_v_training %>%
  ...
  labs(title = "Training Sentences and Mean Surprisal", 
       x = "Sentences", 
       y = "Mean Surprisal (Tested on CNPC)") +
  theme_fivethirtyeight() +
  theme(axis.title = element_text())

ggsave("gpt2_satiation/plots/sentences_v_mean_surprisal_onCNPC.png" )
